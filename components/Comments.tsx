     ...
     {userProfile && <div className='absolute bottom-0 left-0  pb-6 px-2 md:px-10 '>
        <form onSubmit={addComment} className='flex gap-4'>
          <input
            ...
            className='bg-primary px-6 py-4 text-md font-medium border-2 w-[250px] md:w-[700px] lg:w-[350px] border-gray-300 focus:outline-none focus:border-2 focus:border-gray-500 flex-1 rounded-lg'
            placeholder='Add comment..'
          />
          <button className='text-md text-gray-500 ' onClick={addComment}>
